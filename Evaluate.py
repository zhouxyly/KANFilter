...
class Evaluator(object):
    ...
    def __init__(self, output_pcl_dir, dataset_root, dataset, summary_dir, experiment_name, device='cuda', res_gts='8192_poisson', logger=BlackHole()):
        ...
        # for mixedA
        # self.gts_pcl_dir = os.path.join(dataset_root, dataset+'_'+res_gts)
        # self.gts_mesh_dir = os.path.join('./data/Mixed/MixedData/Mixed-A/gt/mesh','MixedA_'+res_gts) 
        # for mixedB
        # self.gts_pcl_dir = os.path.join(dataset_root, dataset+'_'+res_gts)
        # self.gts_mesh_dir = os.path.join(dataset_root, 'mesh', dataset+'_'+res_gts)
        # for real
        # self.gts_pcl_dir = os.path.join(dataset_root, dataset)
        # self.gts_mesh_dir = os.path.join(dataset_root, 'mesh', dataset) 
