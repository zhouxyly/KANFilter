...
import logging
from models.KANFilter import KANFilter
...
def main(args):
    ...
    try:
        ...
        trainer = Trainer(
            ...
            callbacks=[
                        ModelCheckpoint(
                             ...
                             save_top_k = -1,
                             dirpath=log_dir,
                             filename='KANFilter-epoch{epoch:02d}-val_loss{val_loss:.6f}',
        ...
        # trainer.fit(model,ckpt_path='./pretrained/KANFilter.ckpt')  # pretrained data
...
if __name__ == '__main__':
    ...
    parser.add_argument('--patches_per_shape_per_epoch', type=int, default=100) # If the graphics card is sufficient, it is recommended to change to 1000
    ...
    ## Model architecture
    parser.add_argument('--loss_type', type=str, default='NN', choices=['NN'])
