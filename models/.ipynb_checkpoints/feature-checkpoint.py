...
class FeatureExtraction(Module):
    def __init__(self, k=32, input_dim=0, z_dim=0, embedding_dim=512, output_dim=3):
        ...
        self.conv2 = DynamicEdgeConv(16, 32)
        self.conv3 = DynamicEdgeConv(32, 64)
        self.conv4 = DynamicEdgeConv(16+32+64, self.embedding_dim)

        self.linear1 = nn.Linear(self.embedding_dim, 128, bias=False)
        self.linear2 = nn.Linear(128, 64)
        self.linear3 = nn.Linear(64, self.output_dim)
        # self.linear1 = KAN([self.embedding_dim,256])
        # self.linear2 = KAN([256,128])
        # self.linear3 = KAN([128,self.output_dim])
